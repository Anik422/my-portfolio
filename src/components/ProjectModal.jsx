    ...
    <AnimatePresence>
      {project && (
        ...
        >
          ...
          >
            <div className="relative transform overflow-hidden rounded-lg bg-white/80 dark:bg-gray-800/80 text-left shadow-xl backdrop-blur-md border border-white/20 dark:border-gray-700/50">
