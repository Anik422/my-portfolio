...
const Experience = () => {
  ...
  const formatDateRange = (startDate, endDate) => {
    ...
    const endStr = endDate === 'Present' ? 'Present' : 
  ...
  return (
    <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900" id="experience" ref={ref}>
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {experience.map((exp, index) => {
              const { formatted, duration } = formatDateRange(exp.startDate, exp.endDate);
                      ...
                      <ul className="space-y-3 pl-2">
                        {exp.achievements.map((achieve, idx) => (
                          ...
                          >
                            ...
                            <span className="text-gray-700 dark:text-gray-300">{achieve}</span>
                          </motion.li>
                        ))}
                      </ul>
                    </div>
